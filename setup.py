...
long_description = re.sub(
    r"!\[(.*?)\]\((docs/_figures/.*?)\)", r"![\1](https://github.com/DHI-GRAS/terracotta/raw/main/\2)", long_description
)
...
setup(
    ...
    # dependencies
    setup_requires=["setuptools_scm", "setuptools_scm_git_archive", "numpy%s" % numpy_version],
    install_requires=[
        "apispec>=1.0",
    ...
    extras_require={
        ...
        "docs": ["sphinx", "sphinx_autodoc_typehints", "sphinx-click", "pymysql>=1.0.0"],
        "recommended": ["colorlog", "crick", "pymysql>=1.0.0"],
    },
    # CLI
    entry_points="""
        [console_scripts]
    ...
    package_data={"terracotta": ["cmaps/data/*_rgba.npy", "templates/*.html", "static/*"]},  # colormaps  # preview app
)
